'use client';
 ...
 export default function Home() {
     // Using a vibrant gradient background on the container
     ...
     const [themeColor, setThemeColor] = useState('bg-gradient-to-r from-green-400 to-blue-500 shadow-2xl shadow-black/40');
     ...
     return (
         <div className={cn("container mx-auto p-4 transition-colors duration-500", themeColor)}>
             ...
             <h2 className="mb-4 text-2xl font-semibold text-white drop-shadow-md">Effortlessly track your nutrition!</h2>
 

             <div className="mb-4">
                 {imageDataUrl ? (
                     <img src={imageDataUrl} alt="Uploaded Food" className="w-full aspect-video rounded-md shadow-lg" />
                 ) : (
             ...
             <div className="mb-6">
                 ...
                 {foodItems.map((item, index) => (
                     <div key={index} className="mb-4 p-2 border rounded flex flex-col gap-2 bg-white shadow-md">
                         <div>
                 ...
                 <Button variant="secondary" onClick={handleAddFoodItem} className="bg-indigo-500 hover:bg-indigo-600 text-white">
                     Add Food Item
                 </Button>
             </div>
